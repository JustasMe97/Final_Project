...
@section('content')
    <a href="{{route('fuelTypes.create')}}" class="btn text-light greentodarkgreentogreen">{{__('Pridėti naują')}}</a>
        ...
        <tr>
            ...
            <th>
                <div class="d-flex flex-row">
                    ...
                    <form action="{{route('fuelTypes.destroy', $fuelType->id)}}" method="post">
                        @csrf
                        @method('DELETE')
